...
const nbImpoRange = document.getElementById('nbImpoRange');
const nbImpoOutput = document.getElementById('nbImpo');
nbImpoOutput.value = nbImpoRange.value;

const gameDurationRange = document.getElementById('gameDurationRange');
const gameDurationOutput = document.getElementById('gameDuration');
gameDurationOutput.value = gameDurationRange.value;

const nbDechetsRange = document.getElementById('nbDechetsRange');
const nbDechetsOutput = document.getElementById('nbDechets');
nbDechetsOutput.value = nbDechetsRange.value;

const modeIncognito = document.getElementById('incognito')
...
socket.on('newInfo', (data) => {
    ...
    if(roomInfos.modeIncognito){
        ...
        modeIncognito.checked = false;
    }

    nbImpoRange.value = roomInfos.nbImposteur;
    nbImpoOutput.value = roomInfos.nbImposteur;

    speedRange.value = roomInfos.speed;
    speedOutput.value = roomInfos.speed;
...
speedRange.oninput = function () {
    ...
    socket.emit('speed', speedOutput.value)
}
...
nbImpoRange.oninput = function () {
    nbImpoOutput.value = this.value;
    socket.emit('nbImpo', nbImpoOutput.value)
}
nbImpoOutput.oninput = function () {
    nbImpoRange.value = this.value;
    socket.emit('nbImpo', nbImpoOutput.value)
}

gameDurationRange.oninput = function () {
    gameDurationOutput.value = this.value;
...
nbDechetsRange.oninput = function () {
    nbDechetsOutput.value = this.value;
    socket.emit('nbDechets', nbDechetsOutput.value)
}
nbDechetsOutput.oninput = function () {
    nbDechetsRange.value = this.value;
    socket.emit('nbDechets', nbDechetsOutput.value)
}

modeIncognito.oninput= ()=>{
    socket.emit('modeIncognito', modeIncognito.checked);
}
...
function settingOn(ownerId, clientId) {
    if (ownerId == clientId) {
